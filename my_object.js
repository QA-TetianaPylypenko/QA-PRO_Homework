...
/*
Завдання
Створити об'єкт з щонайменше трьома властивостями. Написати метод getInfo(), який виводитиме всі властивості об'єкта у вигляді пар "ключ: значення". 
Метод повинен працювати навіть після додавання нових властивостей до об'єкта. 
*/
